      ...
      MaterialPageRoute(
        builder: (context) {
          return MapPage(
            ...
            barTitle: '検索結果',
            filters: {
              keyString[SavedKeys.isVacant]!: _isVacant,
              keyString[SavedKeys.washlet]!: _washlet,
              keyString[SavedKeys.multipurpose]!: _multipurpose,
              keyString[SavedKeys.madeYear]!: _madeYear,
              keyString[SavedKeys.notRecyclePaper]!: _notRecyclePaper,
              keyString[SavedKeys.doublePaper]!: _doublePaper,
              keyString[SavedKeys.seatWarmer]!: _seatWarmer,
            },
          );
        },
      ),
